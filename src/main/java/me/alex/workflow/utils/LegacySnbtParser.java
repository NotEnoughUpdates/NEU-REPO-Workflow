/**
 * https://github.com/SkyblockerMod/Skyblocker/blob/main/src/main/java/de/hysky/skyblocker/utils/datafixer/LegacyStringNbtReader.java
...
public class LegacySnbtParser {
	...
	public LegacySnbtParser(StringReader reader) {
		this.reader = reader;
	}
	...
	public static CompoundTag parse(String string) throws CommandSyntaxException {
		return new LegacySnbtParser(new StringReader(string)).readCompound();
	}
